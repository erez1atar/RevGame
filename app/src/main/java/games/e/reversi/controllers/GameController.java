...
import games.e.reversi.Connection.TurnData;
import games.e.reversi.Features.MyAccelometer;
...
import games.e.reversi.model.GameStateManager;
import games.e.reversi.model.IModel;
import games.e.reversi.utility.App;
import games.e.reversi.utility.LevelsModeManager;
