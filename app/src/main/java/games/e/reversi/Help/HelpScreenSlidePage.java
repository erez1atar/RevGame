...
public class HelpScreenSlidePage extends Fragment
{
    ...
    public static games.e.reversi.Help.HelpScreenSlidePage newInstance(String text , int imageId)
    {
        Bundle args = new Bundle();
        games.e.reversi.Help.HelpScreenSlidePage fragment = new games.e.reversi.Help.HelpScreenSlidePage();
